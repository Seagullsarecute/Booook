...
<head>
    ...
    <link rel="stylesheet" href="stylesheet/recordPage.css">
...
<body>
    ...
    <div id="wrapper">
        ...
        <h2>Lista scambi utente</h2>
        <p id="description">Benvenuto, in questa pagina potrai visualizzare le informazioni di tutti gli scambi di libri dove sei coinvolto. <a href="profilo.php">Ritorna alla pagina profilo</a></p>
        <hr></hr>
        <table id="records-table">
            ...
            $sql = "SELECT 
                    ...
                    WHERE utente_poster.id_utente = $user_id OR utente_accettatore.id_utente = $user_id
                    ORDER BY data DESC";
            ...
            if($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='6'>Nessun record trovato</td></tr>";
            }
            ?>
        </table>
    </div>
