...
(3, 'Marco', 'Bianchi', 'marco.bianchi@email.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'user'),
(4, 'Giulia', 'Rossi', 'giulia.rossi@email.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'user'),
(5, 'Alessandro', 'Verdi', 'alessandro.verdi@email.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'user'),
(6, 'Sofia', 'Gialli', 'sofia.gialli@email.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'user'),
(7, 'Matteo', 'Neri', 'matteo.neri@email.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'user'),
(8, 'Francesca', 'Marrone', 'francesca.marrone@email.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'user'),
(9, 'Luigi', 'Grigio', 'luigi.grigio@email.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'user'),
(10, 'Chiara', 'Arancio', 'chiara.arancio@email.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'user'),
(11, 'Gianni', 'Celeste', 'gianni.celeste@email.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'user'),
(12, 'Anna', 'Rosa', 'anna.rosa@email.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'user');
...
--
ALTER TABLE `copia_libri`
  MODIFY `id_copia_libro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT per la tabella `info_libri`
--
ALTER TABLE `info_libri`
  MODIFY `id_info_libro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
